<template>
  <div class="map_container">
    <div class="title">
      <p>
        平台高峰实时预警 <span>({{ earlyWarningNum }}条)</span>
      </p>
      <img src="@/assets/images/screen/dataScreen-header-warn-bg.png" alt="" />
    </div>
    <div class="left_title">景区实时客流量</div>
    <div
      class="map_charts"
      ref="mapCharts"
...
const earlyWarningNum = ref(6);
const mapCharts = ref<HTMLDivElement>();
...
onMounted(() => {
  ...
  echarts.init(mapCharts.value).setOption(mapOption);
});
</script>
